...
pt8        =#Answer 1.7.1. Fill in the appropriate value and complete this line to get correct index 
...
What is the specificity for a model that has a sensitivity as close to .8 as we can make it in this problem? What threshold does it occur at?

```{r}
#### Answer 2.4.1. 
```

The threshold is `r thresholdLDA`.
The sensitivity is `r sensitivityLDA`.
The specificity is `r specificityLDA`.
